...
public final class ArithCodeInputStream extends InputStream {
	 ...
	 */
	public ArithCodeInputStream(ArithDecoder decoder, ArithCodeModel model)
		throws IOException {
		_decoder = decoder;
		_model = model;
		decodeNextByte();
	 ...
	 * @throws IOException If there is an I/O exception in the underlying input stream.
	 */
	public ArithCodeInputStream(BitInput in, ArithCodeModel model)
		throws IOException {
	 ...
	 * @throws IOException If there is an I/O exception in the underlying input stream.
	 */
	public ArithCodeInputStream(BufferedInputStream in, ArithCodeModel model)
		throws IOException {
	 ...
	 * @throws IOException If there is an I/O exception in the underlying input stream.
	 */
	public ArithCodeInputStream(InputStream in, ArithCodeModel model)
		throws IOException {
	...
	private void decodeNextByte() throws IOException {
		...
		while (true) {
			_nextByte =
				_model.pointToSymbol(
					_decoder.getCurrentSymbolCount(_model.totalCount()));

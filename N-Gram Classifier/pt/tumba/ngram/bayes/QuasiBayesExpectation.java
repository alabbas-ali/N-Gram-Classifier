...
public class QuasiBayesExpectation extends Expectation {
  ...
  protected void initialize_inference() {
    inference = new QuasiBayesInference(bn, do_produce_clusters);
  }
  ...
  protected void do_expectation_from_inference(DiscreteFunction df) {
    ...
    if (((QuasiBayesInference)inference).is_inference_without_local_neighborhoods)
  ...
  private void expectation_with_local_neighborhoods(DiscreteFunction df) {
    ...
    normalized_results =
        ((QuasiBayesInference)inference).list_of_local_neighborhood_results;
  ...
  private void expectation_without_local_neighborhoods(DiscreteFunction df) {
   QuasiBayesInference qb_inference = (QuasiBayesInference)inference;

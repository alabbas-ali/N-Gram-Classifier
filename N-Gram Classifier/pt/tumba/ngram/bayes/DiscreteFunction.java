...
public class DiscreteFunction implements Serializable {
    ...
    /**
     * Evaluate a function given a (possibly partial) instantiation of variables through the indexes. Indexes indicate
     * which variables are present in the function to be evaluated, assuming an array of DiscreteVariable objects is
     * present.
     *
     * @param pvs           The array of DiscreteVariable objects that is used to compute the position indicated by the
     *                      markers.
     ...
     *
     * @param markers A boolean vector indicating which variables are to be summed out. If markers[i] is true, then the
     ...
     *
     * @param index Position of the variable to be returned in the array of DiscreteVariable objects.
     */

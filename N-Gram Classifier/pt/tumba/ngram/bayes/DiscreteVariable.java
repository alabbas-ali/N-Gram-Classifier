...
public class DiscreteVariable implements Serializable {
    ...
    /**
     * Produce an array of numeric values for the values of a variable. The values are direct translation of the string
     * values into doubles; if the translation fails for a particular value, that value is replaced by its index.
     */
